...
public class ApplicationController {
    ...
    public String addApplication(Model model, Principal principal) {
        ...
        // Retrieve companies associated with the legal representatives
        List<Company> companies = new ArrayList<>();
        for (LegalRepresentative legalRepresentative : legalRepresentatives) {
            List<Company> companiesByLegalRepresentative = companyDAO.getCompaniesByLegalRepresentativeId(legalRepresentative.getId());
            companies.addAll(companiesByLegalRepresentative);
        }
